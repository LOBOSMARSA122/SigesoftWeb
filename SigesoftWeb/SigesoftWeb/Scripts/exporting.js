...
(function (k) { "object" === typeof module && module.exports ? module.exports = k : k(Highcharts) })(function (k) {
    (function (f) {
        var k = f.defaultOptions, A = f.doc, B = f.Chart, x = f.addEvent, H = f.removeEvent, E = f.fireEvent, p = f.createElement, C = f.discardElement, v = f.css, n = f.merge, q = f.pick, h = f.each, F = f.objectEach, t = f.extend, I = f.isTouchDevice, D = f.win, G = D.navigator.userAgent, J = f.Renderer.prototype.symbols; /Edge\/|Trident\/|MSIE /.test(G); /firefox/i.test(G); t(k.lang, {
            printChart: "Imprimir Grafico", downloadPNG: "Descargar imagen PNG", downloadJPEG: "Descargar imagen JPEG",
            downloadPDF: "Descargar documento PDF", downloadSVG: "Descargar imagen SVG", contextButtonTitle: "Menu de Grafico"
